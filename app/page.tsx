    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <header className="fixed top-0 z-40 w-full backdrop-blur-md bg-background/80 border-b border-border/40">
        ...
        <div className="ml-4 flex space-x-2">
          <button onClick={() => setLanguage('it')} className="text-sm">🇮🇹</button>
          <button onClick={() => setLanguage('en')} className="text-sm">🇬🇧</button>
        </div>
        ...
        <div className="space-y-6">
          <Card className="apple-card">
            <CardContent className="p-8">
              ...
              <Dialog><DialogTrigger asChild><Button variant="outline" className="w-full">
