...
<section id="progetti" className="apple-section bg-background">
  <div className="container px-4 md:px-6">
    <div className="max-w-3xl mx-auto space-y-12 text-center">
      <div className="space-y-4 fade-in">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Progetti e Iniziative</h2>
        <p className="text-xl text-muted-foreground">Eventi, concorsi e iniziative artistiche curate o seguite</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 fade-in delay-1">
        <div className="p-6 border rounded-lg shadow-sm hover:shadow-lg transition duration-300">
          <h3 className="text-xl font-semibold mb-2">Young Artists Promotion</h3>
          <p className="text-muted-foreground text-sm">
            Come vicepresidente dell'associazione, coordino eventi artistici, corsi e concorsi per giovani talenti.
          </p>
        </div>
        <div className="p-6 border rounded-lg shadow-sm hover:shadow-lg transition duration-300">
          <h3 className="text-xl font-semibold mb-2">Formazione nuovi addetti vendita</h3>
          <p className="text-muted-foreground text-sm">
            Affiancamento e formazione sul campo per nuovi collaboratori durante l'apertura di punti vendita.
          </p>
        </div>
      </div>
    </div>
