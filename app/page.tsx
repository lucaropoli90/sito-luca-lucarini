...
import { useTheme } from "next-themes"; type { Metadata } from "next"
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <header className="fixed top-0 z-40 w-full backdrop-blur-md bg-background/80 border-b border-border/40">
        <div className="container flex h-16 items-center justify-between">
          ...
          <DialogContent>
            <img src="/images/formazione-generale.jpg" alt="Attestato Formazione Generale" className="w-full h-auto rounded" />
          </DialogContent>
        </Dialog>
      ...
      <div className="fixed top-4 right-4 z-50">
        <button
          ...
          className="px-4 py-1 rounded-md text-sm border border-gray-500 dark:border-white"
        >
          {language === "it" ? "EN" : "IT"}
        </button>
      </div>
          ...
          <DialogContent>
            <img src="/images/formazione-generale.jpg" alt="Attestato Formazione Generale" className="w-full h-auto rounded" />
                ...
                <Button asChild variant="outline" className="apple-button-secondary">
                  <Link href="#documenti">Visualizza CV
          </DialogTrigger>
          <DialogContent>
            <img src="/images/formazione-generale.jpg" alt="Attestato Formazione Generale" className="w-full h-auto rounded" />
          </DialogContent>
