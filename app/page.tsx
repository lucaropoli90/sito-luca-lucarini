...
<section id="testimonianze" className="apple-section bg-background">
  <div className="container px-4 md:px-6">
    <div className="max-w-5xl mx-auto space-y-12">
      <div className="space-y-4 text-center fade-in">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Testimonianze</h2>
        <p className="text-xl text-muted-foreground">Cosa dicono i miei colleghi</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 fade-in delay-1">
        <Card className="apple-card">
          <CardContent className="p-6 space-y-4">
            <p className="text-muted-foreground">"Luca è un professionista affidabile e sempre pronto a supportare il team con entusiasmo."</p>
            <p className="text-sm text-muted-foreground">– Marco Rossi, Ex Collega presso Trony</p>
          </CardContent>
        </Card>

        <Card className="apple-card">
          <CardContent className="p-6 space-y-4">
            <p className="text-muted-foreground">"La sua capacità di leadership e organizzazione ha portato significativi miglioramenti nel nostro punto vendita."</p>
            <p className="text-sm text-muted-foreground">– Giulia Bianchi, Store Manager presso Lidl</p>
          </CardContent>
        </Card>
      </div>
    </div>
